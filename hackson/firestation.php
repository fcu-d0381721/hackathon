...
<head>
	...
	<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="./images/icons/fire-truck.png" />
	<!--===============================================================================================-->
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #6699CC;">
  <a class="navbar-brand" href="#">消防端監控面版</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./map.php">緊急通報</a>
  ...
  <div id="firestation_table" style="margin: 35px;">
    <?php include './firestation_table.php'; ?>
  </div>
